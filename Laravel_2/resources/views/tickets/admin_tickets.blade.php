                    ...
                    <tr class="bg-white  border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        @if($ticket['status'])
                            <form method="post" action="{{route("tickets.close", [$ticket])}}">
                                ...
                                @else
                                <button disabled type="submit" class="focus:outline-none disabled:opacity-25 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" style="padding:8px 40px;margin-top:25px;">
                                    Cerrar
                                </button>
                            </form>
                            @endif
